    ...
    <div className='flex flex-col md:flex-row md:justify-between md:items-center items-center min-h-screen overflow-y-auto p-4 pt-20 md:pt-0 md:p-0'>
        ...
        <div className='flex flex-col gap-12 w-full max-w-[400px]'>
          <div className='flex flex-col gap-8'>
            ...
            <div className='flex flex-col gap-2'>
              <h1 className='text-[#F5F5F5] text-[16px] font-normal'>What's included</h1>
          ...
          <div className='flex flex-col gap-2'>
            <h1 className='flex items-center text-[#f7f7f7] text-[14px] font-normal gap-2'><StarIcon fill='#068f78' stroke='#068f78'  className='w-3 h-3' />Trustpilot</h1>
      ...
      <div className='flex flex-col justify-center gap-4 z-[1] bg-white rounded-lg py-6 px-6 md:py-8 md:px-10 md:mr-[100px] w-full max-w-[400px]'>
        ...
        <div className='flex gap-3'>
          ...
          <button type='button' className='flex-1 flex justify-center items-center py-2 rounded-full bg-[#1877F2] text-white hover:bg-[#166FE5] transition' aria-label='Meta'>
          <svg fill="#ffffff" viewBox="0 0 36 36" id="Camada_1" version="1.1" xml:space="preserve" xmlns="http://www.w3.org/2000/svg" className='w-8 h-8' xmlns:xlink="http://www.w3.org/1999/xlink" stroke="#ffffff"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"><path d="M5,19.5c0-4.6,2.3-9.4,5-9.4c1.5,0,2.7,0.9,4.6,3.6c-1.8,2.8-2.9,4.5-2.9,4.5c-2.4,3.8-3.2,4.6-4.5,4.6 C5.9,22.9,5,21.7,5,19.5 M20.7,17.8L19,15c-0.4-0.7-0.9-1.4-1.3-2c1.5-2.3,2.7-3.5,4.2-3.5c3,0,5.4,4.5,5.4,10.1 c0,2.1-0.7,3.3-2.1,3.3S23.3,22,20.7,17.8 M16.4,11c-2.2-2.9-4.1-4-6.3-4C5.5,7,2,13.1,2,19.5c0,4,1.9,6.5,5.1,6.5 c2.3,0,3.9-1.1,6.9-6.3c0,0,1.2-2.2,2.1-3.7c0.3,0.5,0.6,1,0.9,1.6l1.4,2.4c2.7,4.6,4.2,6.1,6.9,6.1c3.1,0,4.8-2.6,4.8-6.7 C30,12.6,26.4,7,22.1,7C19.8,7,18,8.8,16.4,11"></path></g></svg>
          </button>
        </div>  
